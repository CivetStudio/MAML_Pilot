...
#     if len(sys.argv) == 1:
#
#         sys_text = """MAMLPilot——全平台代码加密工具_20240206
...
#
#             app = wx.App()
#             frame = MyFrame(None, "MAMLPilot 使用说明")
#             app.MainLoop()
#
#         else:
#             print(sys_text)
#             # print('\t')
#             # print('MAMLPilot——全平台代码加密工具_20230716_V1.3')
...
def getLibContent(lib_file_main, soup_dom_id=0, soup_dom_input=None):
    ...
    with open(lib_slot_xml, 'w', encoding='utf-8') as _f0:
        ...
        if soup_dom_input is None:
            ...
            soup_dom_input_r = '_' + str(soup_dom_input)
    ...
    if _var_alias_all == 1:
        ...
        if src_exp_mode:
            ...
            for image in _soup_final.find_all():
                if image.get('src') and 'srcid' in image.attrs and image.get('_src_exp_mode') != '0':
