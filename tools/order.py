...
def orderXML(input_file, output_file=None, xml_minify=0):
    ...
    # 定义新的属性顺序
    new_attribute_order = ["frameRate", "screenWidth", "version", "vibrate", "_dev", "_devDate", "_devTime", "_splitExt", "_splitGroup", "_preload", "_getSource", "_pauseIntent", "compiler",
                           "name", "type", "rate", "extra", "count", "index", "indexName", "expression", "values",
