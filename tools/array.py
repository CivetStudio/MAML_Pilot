...
xml_content = """
    ...
    <C_Array count="3" indexName="index" >
    
        <Button x="50" y="100+106*#index" w="400" h="100" visibility="1">
            <Triggers>
                <Trigger action="click">
                    <VariableCommand persist="true" name="_id_#index" expression="not(#_id_#index)" type="number" />
                </Trigger>
            </Triggers>
        </Button>
